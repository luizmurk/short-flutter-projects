...
//      Color(0x0000006E),
  ...
  static const Gradient grapeGradient = LinearGradient(
    colors: [
      Color(0xFF311B92), //Deep Purple 900
      Color(0xFF651FFF), //Deep Purple Accent 400
    ],
  );

  static const Gradient sweetnessGradient = LinearGradient(
    colors: [
  ...
  static const Gradient acidityGradient = LinearGradient(
    colors: [
  ...
  static const Gradient intensityGradient = LinearGradient(
    colors: [
  ...
  static const Gradient tanninGradient = LinearGradient(
    colors: [
  ...
  static const Gradient wineTypeGradient = LinearGradient(
    colors: [
      Colors.red,
      Colors.blue,
    ],
  ...
  static const Gradient regionsGradient = LinearGradient(
    colors: [
  ...
  static const Gradient countriesGradient = LinearGradient(
    colors: [
      Colors.deepPurple,
      Colors.indigo,
    ],
  ...
  static const Gradient foodsGradient = LinearGradient(
    colors: [
      Colors.deepPurple,
      Colors.indigo,
    ],
